...
export class ChildComponent implements OnInit {
  ...
  reserveEvent() {
    ...
    alert(`Réservation confirmée pour ${this.child.firstName} ${this.child.lastName} pour l'événement.`);
    this.child.history?.push({
      date: new Date().toISOString().split('T')[0],
      description: 'Réservation pour un événement'
    });
  }
